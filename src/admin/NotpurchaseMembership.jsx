...
const NotpurchaseMembership = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center bg-white">
            ...
            <div className='bg-[#5bc0de] rounded-sm border relative border-t-8 border-[#109ae7] h-[60px] w-full mb-4 '>
                <div className='text-white text-[20px] flex items-center h-full pl-14 gap-4'>
                    <div className='w-6 bg-[#109ae7] h-10 flex items-center justify-center absolute left-3 top-0'><BsFillExclamationTriangleFill/></div>
                    Sorry! You can not add or publish any more product. Please
                    <span className='text-[#046bd2] cursor-pointer' onClick={()=>navigate('/admin/membership')}>update your package.</span>
                </div>
            </div>
...
export default NotpurchaseMembership