        ...
        <div className="flex flex-col items-center justify-center bg-white">
            ...
            <div className='bg-[#5bc0de] rounded-sm border relative border-t-8 border-[#109ae7] h-[60px] w-full mb-4 '>
                <div className='text-white text-[20px] flex items-center h-full pl-14 gap-4'>
                    ...
                    Sorry! You can not add or publish any store. Please
                    <span className='text-[#046bd2] cursor-pointer' onClick={() => navigate('/admin/settings/store')}>Add a new store.</span>
                </div>
            </div>
            ...
            <div className="p-4 bg-white flex flex-col items-center ">
                ...
                <h2 className="text-2xl font-bold mt-4">No Store Found!</h2>
