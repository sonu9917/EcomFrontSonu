    ...
    <div className="p-4">
      <div className="flex justify-between items-center mb-4 border-b-[1px] pb-4">
        <div className='flex items-center gap-4 font-bold'>
          <span className='text-[24px] pt-[13px] '>Shipping Settings</span> <span className='text-[80%] pt-3'>→</span> <Link to={'/admin/visitStore'} className='text-[#F05025] pt-3 text-[19px] cursor-pointer'>Visit Store</Link>
        </div>
        <button
